...
const Footer: React.FC<IFooterProps> = (_props: IFooterProps) => {
  return (
      ...
      <div className='pt-16 pb-12 text-sm border-t border-slate-900 bg-slate-800'>
        <div className='container px-6 mx-auto'>
          <div className='grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12'>
            <nav
              className='col-span-2 md:col-span-4 lg:col-span-4 justify-self-center'
              aria-labelledby='footer-product-dark'
            >
              <h3 className='mb-6 text-base font-medium text-white' id='footer-product-dark'>
                Trọ Alolola
              </h3>
              <ul>
                <li className='mb-2 leading-6'>
                  <a href='/' className='transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600'>
                    Trang chủ
                  </a>
                </li>
                <li className='mb-2 leading-6'>
            ...
            >
              <h3 className='mb-6 text-base font-medium text-white' id='footer-about-dark'>
                Điều Khoản & Dịch vụ
              </h3>
              <ul>
                <li className='mb-2 leading-6'>
            ...
            >
              <h3 className='mb-6 text-base font-medium text-white' id='footer-get-in-touch-dark'>
                Chi tiết liên hệ
              </h3>
              <ul>
                <li className='mb-2 leading-6'>
                  <a
                    href='javascript:void(0)'
                    className='transition-colors flex items-center justify-start duration-300 hover:text-emerald-500 focus:text-emerald-600'
                  >
                    <svg
                    ...
                    <span className='ms-3'>Đại Học Cần Thơ</span>
                  </a>
                </li>
                <li className='mb-2 leading-6'>
                  <a
                  ...
                  >
                    ...
                    <span className='ms-3'>thaib2005731@student.ctu.edu.vn</span>
                  </a>
                </li>
                <li className='mb-2 leading-6'>
                  <a
                  ...
                  >
                    ...
                    <span className='ms-3'>0397706494</span>
                  </a>
                </li>
                <li className='mb-2 leading-6'>
                  <a
                  ...
                  >
                    ...
                    <span className='ms-3'>Giờ hoạt động: 8h - 23h </span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div className='container px-6 mx-auto'>
          <div className='grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12'>
            <div className='col-span-2 md:col-span-4 lg:col-span-6'>
              Chau Thai - B2005731 | thaib2005731@student.ctu.edu.vn
            </div>
            <nav
