...
const UpdateProfile: React.FC<IUpdateProfileProps> = (_props: IUpdateProfileProps) => {
  ...
  return (
    <div className='max-w-screen-lg bg-white mx-auto  mt-24 mb-6  py-8 px-0 md:px-52'>
      <div className='text-gray-600 font-medium py-5 text-center text-3xl'>Cập nhật thông tin người dùng</div>
      {!updateProfileMutation.isLoading && (
        <form noValidate onSubmit={handleSubmit(handleUpdateProfile)}>
          ...
          <div className='text-center mb-6'>
            <Button
              type='submit'
              className='flex gap-3 justify-center items-center h-10 px-4 py-2 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 w-full md:w-1/2 md:mx-auto text-white bg-primary-800 hover:bg-primary-700 focus:ring-primary-600'
            >
              {
                <svg
                  className='w-6 h-6'
